...
# %% ../../nbs/helpers/02_submit.ipynb #92f449db
import os
import httpx
import nbformat
...
# %% ../../nbs/helpers/02_submit.ipynb #63645100
...
# %% ../../nbs/helpers/02_submit.ipynb #ce6552c1
...
# %% ../../nbs/helpers/02_submit.ipynb #6214be45
...
# %% ../../nbs/helpers/02_submit.ipynb #532422b9
...
# %% ../../nbs/helpers/02_submit.ipynb #04698ff8
def submit_answers(
    student_id,
    *,
    answers=None,
...
# %% ../../nbs/helpers/02_submit.ipynb #eb45e524
def review_answers(*, namespace=None, dname=None, path=None, show=True):
    ...
    if show:
        ...
        for k, v in answers.items():
            print(f"{k}: {v!r}")
        print("=" * 60)
        print("⚠️  Nothing has been submitted.")
